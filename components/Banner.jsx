...
export default function Banner() {
  return (
    <div className={`${styles.bannerBg} text-center md:p-24 p-12 text-white`}>
      <p className="text-base md:text-xl pb-6">ONLINE TEACHING MARKETPLACE & E-LEARNING PLATFORM</p>
      <h2 className="text-3xl pb-6">Empower Yourself with Our Dynamic Online Learning Platform</h2>
